...
public class GameObjectPool : MonoBehaviour
{
    ...
    public static GameObjectPool Instance
    {
        get
        {
            ...
            if(instance==null)
            {
                GameObject temp = new GameObject("GameObjectPool");
                instance = temp.AddComponent<GameObjectPool>();
            }
            return instance;
        }
    }
    ...
    { 
        ...
        {
            targetObject = Instantiate<GameObject>(go);
    ...
    {
        foreach (List<GameObject> item in cache.Values)
        {
            for (int i = 0; i < item.Count; i++)
            {
                CollectObject(item[i]);
            }
        }
    }
